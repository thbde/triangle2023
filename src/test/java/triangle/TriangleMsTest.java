...
public class TriangleMsTest {
    public static final Triangle triangle = new TriangleMSchneider();
    ...
    @Test
    public void testGetTriangleResultForFourInputs() {
    ...
    @Test
    public void testGetTriangleResultForTwoInputs() {
        final int[] input = {1, 2};
        final TriangleResult expected = TriangleResult.UNKNOWN;
        final TriangleResult result = triangle.getTriangleResultForLengths(input);
        assertThat(result).isEqualTo(expected);
    ...
    @Test
    public void testGetTriangleResultForNegativeInputs() {
    ...
    @Test
    public void testGetTriangleResultForNullInputs() {
    ...
    @Test
    public void testGetTriangleResultForNullAndFourInputs() {
        final int[] input = {-1, 0, 2, 7};
        final TriangleResult expected = TriangleResult.UNKNOWN;
        final TriangleResult result = triangle.getTriangleResultForLengths(input);
        assertThat(result).isEqualTo(expected);
    }
